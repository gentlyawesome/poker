function poker(connection) {
	...
	connection.onstream = function(event){
	  ...
	  if(event.type == 'remote'){
	    console.log(event.extra.camID);
	    var vidContainerRemote = document.getElementById(event.extra.camID);
	    vidContainerRemote.srcObject = event.stream;
	  }
	};
